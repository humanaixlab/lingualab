...
const COPY = {
  ar: {
    ...
    executionTitle: "كيف تعمل مهام NLP هنا؟", executionText: "ينفذ مختبر مهام NLP المهمة باستخدام نموذج ذكاء اصطناعي عبر الـAPI ضمن تعليمات وفئات وبنية مخرجات يحددها الباحث. تُعاد النتيجة في صيغة منظمة، ثم يتحقق النظام من توافقها مع القيود المحددة، ويظل للباحث قرار قبول النتيجة أو تعديلها أو رفضها.", executionContrast: "هذه الآلية تختلف عن تشغيل خوارزمية NLP برمجية مستقلة مثل Naive Bayes أو TF-IDF أو محلل صرفي حتمي. وعندما تستخدم LinguaLab حسابًا حتميًا، يظهر ذلك بوضوح.", executionType: "نوع التنفيذ: استدلال مدعوم بالذكاء الاصطناعي", executionFlow: ["يحدد الباحث المهمة", "تبني الواجهة طلبًا منظمًا", "تنفذ الـAPI نموذج الذكاء الاصطناعي", "تعود استجابة JSON منظمة", "تحقق برمجي من النتيجة", "يقبل الباحث النتيجة أو يعدلها أو يرفضها"],
  },
  en: {
