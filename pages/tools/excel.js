  ...
  return (
    <Layout title={copy.title} description={copy.description} backHref="/research-planner#build-tools" backLabel={language === "ar" ? "العودة إلى البناء" : "Back to Build"} dataSource="standalone">
      <div style={{ ...styles.page, direction, textAlign: "start" }}>
        ...
        <ComputationalWorkbench language={language} methodType="preparation" stages={WORKBENCH[language].map(([label, detail]) => ({ label, detail }))} />
