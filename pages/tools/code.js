...
export default function CodeTool() {
  ...
  return (
    <Layout title={copy.title} description={copy.description} backHref="/research-planner#build-tools" backLabel={uiLanguage === "ar" ? "العودة إلى البناء" : "Back to Build"} dataSource={handoffSource ? "transferred" : "standalone"}>
