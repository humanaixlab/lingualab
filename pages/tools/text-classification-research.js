...
const COPY = {
  ar: {
    ...
    lead: "اختبر نموذجًا مرجعيًا بسيطًا (Baseline) بحساب حتمي، وراجع تصنيفًا مقترحًا بالذكاء الاصطناعي، وافحص الأخطاء مقارنةً بالمرجع البشري (Human Reference / Gold Standard).", notice: "المخرجات مقترحات تحليلية مدعومة بالذكاء الاصطناعي، ويظل الباحث مسؤولًا عن التحقق من النتائج واعتمادها في الاستخدام البحثي.",
    baseline: "التصنيف الأساسي بنموذج مرجعي بسيط (Baseline)", baselineDesc: "درّب نموذج Naive Bayes مرجعيًا بسيطًا على بيانات عربية مصنفة من الباحث.", ai: "التصنيف بمساندة الذكاء الاصطناعي", aiDesc: "اطلب تصنيف نص ضمن فئات مغلقة يحددها الباحث ثم راجع الاقتراح.", errors: "تحليل أخطاء التصنيف (Error Analysis)", errorsDesc: "قارن توقع النظام بالتصنيف المرجعي البشري وافحص أنماط عدم التطابق.",
    ...
    baselineResults: "نتائج النموذج المرجعي البسيط (Baseline) المحسوبة حتميًا", training: "سجلات التدريب", testing: "سجلات الاختبار", accuracy: "الدقة (Accuracy)", vocabulary: "حجم المفردات", matrix: "مصفوفة الالتباس (Confusion Matrix)", actualPredicted: "المرجع البشري × توقع النظام",
