...
const COPY = {
  en: { title: "Prompt Builder", description: "Create clear, structured instructions for research, analysis, and writing tasks.", intro: "Build an editable prompt from your task, topic, audience, and preferred writing style.", task: "Task type", topic: "Topic", topicPlaceholder: "Example: Sentiment patterns in customer reviews", audience: "Target audience", audiencePlaceholder: "Example: Undergraduate researchers", style: "Writing style", generate: "Generate prompt with GPT-5.6", generating: "Generating with GPT-5.6…", clear: "Clear", output: "GENERATED OUTPUT", yours: "Your prompt", copied: "Copied", copy: "Copy prompt", continue: "Continue to Code Builder →", guide: "HOW TO USE THIS TOOL", guideTitle: "Create a stronger starting prompt.", guideText: "Choose a task, describe the topic and audience, then generate a reusable prompt for analysis, explanation, summarization, academic writing, or learning activities.", timeout: "Prompt generation timed out. Please try again.", failed: "Prompt generation failed. Please try again.", unavailable: "The model did not return a usable prompt.", transfer: "The prompt could not be transferred. Please try again.", tasks: ["Text analysis", "Summarization", "Simplified explanation", "Academic writing", "Data classification", "Learning activity design"], styles: ["Academic", "Simple", "Formal", "Creative"] },
  ar: { title: "أداة بناء التعليمات", description: "أنشئ تعليمات واضحة ومنظمة لمهام البحث والتحليل والكتابة.", intro: "أنشئ تعليمات قابلة للمراجعة انطلاقًا من المهمة والموضوع والجمهور وأسلوب الكتابة.", task: "نوع المهمة", topic: "الموضوع", topicPlaceholder: "مثال: أنماط المشاعر في مراجعات العملاء", audience: "الجمهور المستهدف", audiencePlaceholder: "مثال: باحثون في المرحلة الجامعية", style: "أسلوب الكتابة", generate: "أنشئ التعليمات باستخدام GPT-5.6", generating: "جارٍ إنشاء التعليمات باستخدام GPT-5.6…", clear: "مسح", output: "الناتج المنشأ", yours: "تعليماتك", copied: "تم النسخ", copy: "نسخ التعليمات", continue: "المتابعة إلى أداة بناء الكود ←", guide: "طريقة استخدام الأداة", guideTitle: "أنشئ نقطة بداية أكثر وضوحًا.", guideText: "اختر المهمة، وحدد الموضوع والجمهور، ثم أنشئ تعليمات قابلة لإعادة الاستخدام في التحليل أو الشرح أو التلخيص أو الكتابة الأكاديمية أو أنشطة التعلم.", timeout: "انتهت مهلة إنشاء التعليمات. حاول مرة أخرى.", failed: "تعذر إنشاء التعليمات. حاول مرة أخرى.", unavailable: "لم يُرجع النموذج تعليمات قابلة للاستخدام.", transfer: "تعذر نقل التعليمات. حاول مرة أخرى.", tasks: ["تحليل النص", "التلخيص", "شرح مبسط", "الكتابة الأكاديمية", "تصنيف البيانات", "تصميم نشاط تعليمي"], styles: ["أكاديمي", "مبسّط", "رسمي", "إبداعي"] },
};
...
export default function PromptTool() {
  ...
  return (
    <Layout title={copy.title} description={copy.description} backHref="/research-planner#build-tools" backLabel={language === "ar" ? "العودة إلى البناء" : "Back to Build"} dataSource="standalone">
      <div style={{ direction }}>
