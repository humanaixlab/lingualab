...
const COPY = {
  ar: {
    head: "الصرف والنحو · تجريب بحثي", back: "العودة إلى مخطط البحث", eyebrow: "الصرف والنحو", title: "مختبر الصرف والنحو", badge: "تجريب بحثي",
    lead: "منطقة تجريبية لتحليل الكلمة والجملة العربية باستدلال مدعوم بالذكاء الاصطناعي (AI-supported Inference)، مع إبقاء الاعتماد النهائي بيد الباحث.", notice: "المخرجات مقترحات تحليلية مدعومة بالذكاء الاصطناعي، ويظل الباحث مسؤولًا عن التحقق من النتائج واعتمادها في الاستخدام البحثي.",
  ...
  en: {
    head: "Morphology & Syntax · Research Preview", back: "Back to Research Planner", eyebrow: "MORPHOLOGY & SYNTAX", title: "Morphology & Syntax Lab", badge: "Research Preview",
...
export default function MorphologySyntax() {
  ...
  return <>
    ...
    <main className={styles.page}>
      <Link className={styles.back} href="/research-planner#morphology-syntax">← {copy.back}</Link>
