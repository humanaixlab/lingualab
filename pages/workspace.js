...
function createReportHtml(dataset, workflowResult, textColumn, labelColumn, language, t) {
  ...
  :root{font-family:Inter,system-ui,-apple-system,BlinkMacSystemFont,"Segoe UI",sans-serif;font-size:16px;line-height:1.6;}html[lang="ar"]{font-family:"IBM Plex Sans Arabic","Noto Sans Arabic",Tahoma,Arial,sans-serif;font-size:17px;line-height:1.8;color:#18253c;background:#f5f7fb}*{box-sizing:border-box}body{margin:0;padding:40px}.report{max-width:900px;margin:auto;background:white;border:1px solid #e4e8f0;border-radius:24px;padding:44px;box-shadow:0 20px 60px rgba(39,54,87,.10)}.brand{font-weight:700;color:#6151d8}.eyebrow{text-transform:uppercase;letter-spacing:.08em;font-size:13px;color:#7b8799;font-weight:500}.hero{padding-bottom:26px;border-bottom:1px solid #e4e8f0}.hero h1{font-size:36px;line-height:1.18;letter-spacing:-.02em;font-weight:700;margin:10px 0}.hero p{color:#65738a;line-height:1.7}.meta{display:grid;grid-template-columns:repeat(3,1fr);gap:12px;margin:24px 0}.meta div{padding:14px;background:#f7f8fc;border-radius:14px}.meta span{display:block;font-size:13px;color:#8490a2}.meta strong{display:block;margin-top:5px;font-size:14px}section{margin-top:30px}h2{font-size:26px;line-height:1.25;font-weight:700}table{width:100%;border-collapse:collapse}th,td{padding:12px;border-bottom:1px solid #e8ebf2;text-align:start;font-size:14px}th{width:36%;color:#67758a}ul{padding-inline-start:20px;line-height:1.8;color:#46566e}.patterns{display:grid;grid-template-columns:1fr 1fr;gap:18px}.patterns>div{padding:18px;border:1px solid #e4e8f0;border-radius:16px}.patterns ol{padding-inline-start:22px}.patterns li{padding:6px}.patterns span{float:inline-end;font-weight:600}.note{padding:18px;border-radius:15px;background:#17243d;color:#dce3ef;line-height:1.7}.footer{margin-top:38px;padding-top:18px;border-top:1px solid #e4e8f0;color:#8a94a4;font-size:13px}html[lang="ar"] .eyebrow,html[lang="ar"] .hero h1{letter-spacing:0}html[lang="ar"] .hero h1{font-size:38px;line-height:1.3}html[lang="ar"] h2{font-size:28px;line-height:1.3}@media print{body{padding:0;background:white}.report{box-shadow:none;border:0;border-radius:0;max-width:none}}@media(max-width:650px){body{padding:14px}.report{padding:24px}.meta,.patterns{grid-template-columns:1fr}.hero h1{font-size:30px}html[lang="ar"] .hero h1{font-size:32px}}
