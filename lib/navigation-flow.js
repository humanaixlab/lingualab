...
export function reportReturnTarget(sourceTool, language = "en", pathId = null) {
  ...
  const pathHomes = { "morphology-syntax": "/ar-tools#morphology-syntax", semantics: "/ar-tools#semantics", "discourse-pragmatics": "/ar-tools#discourse-pragmatics", "text-classification": "/ar-tools#build-tools", "information-extraction": "/ar-tools#build-tools", "nlp-experiments": "/ar-tools#build-tools" };
