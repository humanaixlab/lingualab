...
export const PROJECT_TOOL_LABELS = Object.freeze({
  "AI Code Assistant": label("AI Code Assistant", "مساعد البرمجة بالذكاء الاصطناعي"),
  "Code Generator": label("Code Generator", "مولّد الشفرة البرمجية"),
  "Concordance / Contexts": label("Concordance / Contexts", "السياقات"),
  "Corpus Research": label("Corpus Research", "إنشاء وتحليل المدونة"),
  "Discourse Analysis": label("Discourse Analysis", "تحليل الخطاب"),
  ...
  "Morphology & Syntax Research Preview": label("Morphology & Syntax Analysis", "التحليل الصرفي والنحوي"),
  "N-grams": label("N-grams", "المتتاليات اللفظية"),
  "NLP Experiments": label("NLP Experiments", "تجارب معالجة اللغة الطبيعية"),
  POS: label("Part-of-Speech Analysis (POS)", "تحليل أقسام الكلام (POS)"),
  Pragmatics: label("Pragmatics", "التداولية"),
  "Prompt Assistant": label("Prompt Assistant", "مساعد التعليمات"),
  "Semantics Research Preview": label("Semantic Analysis", "التحليل الدلالي"),
  "Spreadsheet Explorer": label("Spreadsheet Explorer", "مستكشف الجداول"),
  "Text Classification Research Preview": label("Text Classification", "تصنيف النصوص"),
...
export const PROJECT_TASK_LABELS = Object.freeze({
  ...
  classification: label("Text Classification", "تصنيف النصوص"),
  ...
  "named-entities": label("Named Entity Recognition", "التعرف على الكيانات المسماة"),
  ...
  "relation-extraction": label("Relation Extraction", "استخراج العلاقات"),
  "requirement-extraction": label("Requirement Extraction", "استخراج المتطلبات"),
  segmentation: label("Segmentation", "التقسيم"),
  "semantic-grouping": label("Semantic Grouping", "التجميع الدلالي"),
  "semantic-similarity": label("Semantic Similarity", "التشابه الدلالي"),
  similarity: label("Semantic Similarity", "التشابه الدلالي"),
