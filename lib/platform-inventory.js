...
export const ACTIVE_TOOLS = Object.freeze([
  ...
  ["nlp-builder", "/tools/nlp-builder", "NLP Builder", "بناء المعالجة اللغوية حاسوبيًا"],
  ["spreadsheet", "/tools/excel", "Spreadsheet Explorer", "مستكشف الجداول"],
  ["code", "/tools/code", "Code Builder", "أداة بناء الكود"],
  ["colab", "/tools/colab", "Google Colab Handoff", "الانتقال إلى Google Colab"],
  ["prompt", "/tools/prompt", "Prompt Builder", "أداة بناء التعليمات"],
...
export const INCLUDED_DATASETS = Object.freeze([{
  ...
  source: {
    en: "Fully synthetic records created specifically for LinguaLab. No real user, scraped, copied, or external dataset content.",
    ar: "سجلات مصطنعة بالكامل ومنشأة خصيصًا لـLinguaLab، ولا تتضمن بيانات مستخدمين حقيقية أو محتوى مجمعًا أو منسوخًا أو مأخوذًا من مجموعة خارجية.",
  },
  license: {
    status: "project-owned-cleared-for-redistribution",
    en: "LinguaLab-owned demo content, explicitly cleared for public redistribution under the repository MIT License.",
    ar: "محتوى عرض مملوك لمشروع LinguaLab ومصرح صراحة بإعادة توزيعه علنًا وفق ترخيص MIT للمستودع.",
  },
}]);
