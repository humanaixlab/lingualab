...
export const SCIENTIFIC_FOUNDATIONS = {
  ...
  "text-classification": path("Text Classification", "تصنيف النصوص", [
    { id: "classification-habash-2014", author: "نزار حبش", translator: "هند سليمان الخليفة", year: 2014, title: "مقدمة في المعالجة الطبيعية للغة العربية", publisher: "دار جامعة الملك سعود للنشر", isbn: "9786035072571", doiOrUrl: "https://ksupress.ksu.edu.sa/ar/books/6635/9786035072571", referenceType: "كتاب مترجم إلى العربية", note: "يوفر الأساس اللغوي والحاسوبي لمعالجة النص العربي وبناء المهام الآلية وتقييمها." },
    { id: "classification-rashwan-2019", author: "محسن رشوان، المعتز بالله السعيد", year: 2019, title: "تطبيقات أساسية في المعالجة الآلية للغة العربية", publisher: "مركز الملك عبدالله بن عبدالعزيز الدولي لخدمة اللغة العربية", isbn: "9786038221532", doiOrUrl: "https://library.ksaa.gov.sa/links/epubs/tatbiqat_asasiat_fi_almuealajat_alalyat_lilughat_alearabia.pdf", referenceType: "كتاب", note: "يدعم تصميم تطبيقات معالجة النص العربي وبناء التجارب الحاسوبية وتقييمها." },
    { id: "classification-standards-2025", author: "مجمع الملك سلمان العالمي للغة العربية", year: 2025, title: "معايير الحوسبة اللغوية العربية", publisher: "مجمع الملك سلمان العالمي للغة العربية", doiOrUrl: "https://library.ksaa.gov.sa/links/epubs/maeayir_alhawsabat_allughawiat_alearabia.pdf", referenceType: "كتاب / وثيقة معايير", note: "يدعم جودة البيانات والتوسيم والمعالجة والتقييم في تطبيقات الحوسبة اللغوية العربية." },
  ]),
  "information-extraction": path("Information Extraction", "استخراج المعلومات", [
    { id: "extraction-habash-2014", author: "نزار حبش", translator: "هند سليمان الخليفة", year: 2014, title: "مقدمة في المعالجة الطبيعية للغة العربية", publisher: "دار جامعة الملك سعود للنشر", isbn: "9786035072571", doiOrUrl: "https://ksupress.ksu.edu.sa/ar/books/6635/9786035072571", referenceType: "كتاب مترجم إلى العربية", note: "يدعم التحليل الآلي للعربية اللازم لاستخراج المعلومات والسمات والكيانات من النص." },
    { id: "extraction-jomaa-2024", author: "عمرو جمعة", year: 2024, title: "تقنيات اللغة العربية الحاسوبية: معايير التقويم ورؤى التطوير", publisher: "مجمع الملك سلمان العالمي للغة العربية", doiOrUrl: "https://library.ksaa.gov.sa/links/epubs/tiqniaat_allughat_alearabiat_alhasubia.pdf", referenceType: "كتاب", note: "يدعم تقويم تطبيقات تحليل النص العربي وتقنيات المعالجة الآلية واستخراج المعلومات." },
    { id: "extraction-standards-2025", author: "مجمع الملك سلمان العالمي للغة العربية", year: 2025, title: "معايير الحوسبة اللغوية العربية", publisher: "مجمع الملك سلمان العالمي للغة العربية", doiOrUrl: "https://library.ksaa.gov.sa/links/epubs/maeayir_alhawsabat_allughawiat_alearabia.pdf", referenceType: "كتاب / وثيقة معايير", note: "يدعم توسيم البيانات وتمثيل المعلومات وضمان جودة الموارد المستخدمة في الاستخراج." },
  ]),
  "nlp-experiments": path("NLP Experiments", "تجارب معالجة اللغة الطبيعية", [
    { id: "nlp-habash-2014", author: "نزار حبش", translator: "هند سليمان الخليفة", year: 2014, title: "مقدمة في المعالجة الطبيعية للغة العربية", publisher: "دار جامعة الملك سعود للنشر", isbn: "9786035072571", doiOrUrl: "https://ksupress.ksu.edu.sa/ar/books/6635/9786035072571", referenceType: "كتاب مترجم إلى العربية", note: "مرجع أساسي لبناء تجارب معالجة العربية وفهم مستويات المعالجة وقيودها." },
    { id: "nlp-rashwan-2019", author: "محسن رشوان، المعتز بالله السعيد", year: 2019, title: "تطبيقات أساسية في المعالجة الآلية للغة العربية", publisher: "مركز الملك عبدالله بن عبدالعزيز الدولي لخدمة اللغة العربية", isbn: "9786038221532", doiOrUrl: "https://library.ksaa.gov.sa/links/epubs/tatbiqat_asasiat_fi_almuealajat_alalyat_lilughat_alearabia.pdf", referenceType: "كتاب", note: "يدعم التطبيق العملي وبناء المهام الحاسوبية واختبار المخرجات والتقييم." },
    { id: "nlp-jomaa-2024", author: "عمرو جمعة", year: 2024, title: "تقنيات اللغة العربية الحاسوبية: معايير التقويم ورؤى التطوير", publisher: "مجمع الملك سلمان العالمي للغة العربية", doiOrUrl: "https://library.ksaa.gov.sa/links/epubs/tiqniaat_allughat_alearabiat_alhasubia.pdf", referenceType: "كتاب", note: "يدعم تقويم التقنيات اللغوية الحاسوبية وتحليل جودة المخرجات وتحديد جوانب التحسين في التجارب." },
  ]),
};
