const guidance = {
  ...
  learn: {
    routes: ["/learning-center", "/projects"],
    ar: [
...
const researchPathGuidance = {
  ...
  "discourse-pragmatics": {
    ar: [
      ...
      ["ما الأدوات المتاحة الآن؟", "تتوفر أداة تحليل الخطاب بوصفها تجربة بحثية لمراجعة الموقف والتحفظ والتوكيد والعلاقات الخطابية، وتبقى مخرجاتها خاضعة لقرار الباحث."],
      ["ما الخطوة التالية المناسبة؟", "حدّد الظاهرة الخطابية وسياقها ووحدة التحليل، ثم افتح أداة التجريب البحثي وراجع اقتراحها مقابل النص الأصلي."],
    ],
    en: [
      ...
      ["Which tools are available now?", "The Discourse Analysis research preview supports researcher-reviewed suggestions for stance, hedging and assertion, and discourse relations."],
      ["What is an appropriate next step?", "Define the discourse phenomenon, context, and unit of analysis, then open the research preview and review its suggestion against the source text."],
    ],
  },
